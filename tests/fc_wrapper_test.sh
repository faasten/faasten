...
cat resources/sentiment-analysis.json | ./target/release/fc_wrapper --id 1 --kernel /etc/snapfaas/vmlinux --mem_size 256 --rootfs /etc/snapfaas/resources/runtimefs/python2.ext4 --vcpu_count 2 --appfs /etc/snapfaas/resources/appfs/sentiment-analysis.ext4 
